...
import (
	...
	"github.com/dpb587/gotmpl/pkg/app/cliopt"
...
type Runtime struct {
	...
	Version *cliopt.Version `long:"version" description:"show version of this command (with optional constraint to validate)" optional:"true" optional-value:"*" value-name:"[CONSTRAINT]"`
